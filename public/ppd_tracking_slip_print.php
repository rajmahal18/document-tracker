...
$pageTitle = "Print PPD Tracking Slip";
...
<div class="card" style="max-width: 1100px;">
  <h2 style="margin:0 0 6px;">PPD Document Tracking Slip</h2>
  ...
  <div style="border:1px solid rgba(0,0,0,.08); border-radius:12px; overflow:hidden;">
    <iframe id="pdfFrame"
            src="<?= htmlspecialchars(PUBLIC_PATH . '/view_attachment.php?id=' . $attId) ?>"
            style="width:100%; height:75vh; border:0;"
            title="PPD Tracking Slip PDF"></iframe>
  </div>
</div>
